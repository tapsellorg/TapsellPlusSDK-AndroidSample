...
<div dir="rtl">ابتدا کتابخانه TapsellPlus را مطابق روش زیر به پروژه اضافه کنید سپس هر adNetworke که تپسل پلاس پشتیبانی میکنه و مایل هستید رو مطابق توضیحات به پروژه اضافه کنید. در انتها با روش‌های تست مطمعن شوید که adNetwork مورد نظر به درستی کار میکند.<br /><br /></div>  
...
<div dir="rtl">برای اطمینان از صحبت عمل کرد adNetwrok هایی که اضافه کردید از zoneId مربوط به هرکدام استفاده کنید. هر zoneId مربوط به یک adNetwork و یک نوع تبلیغ هست و تبلیغ حالت تست نمایش داده میشود.</div>
...
<div dir="rtl">* برای تست facebook باید hash دستگاهی که روش تست انجام میشود طبق روش گفته شده به sdk داده شود.</div>
